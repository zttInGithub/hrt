<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
    <div class="easyui-panel" style="height:130px; overflow: hidden; padding-top:5px;">
       <form method="post" enctype="multipart/form-data" id="frmBj" onsubmit="subbutton.disabled=1">
		<input type="hidden" name="unusedEquipmentFile" id="unusedEquipmentFile"/>
		<br/>
            <table align="center">
                <tr>
                    <th>文件：</th>
        ...
        function data_data_searchFunBZ2(){
        	...
        	$('#frmBj').form('submit', { 
			url:'${ctx}/sysAdmin/terminalInfo_updateTerminalInfoUET.action', 
			onSubmit: function(){
				...
				//判断后缀名
					...
					if(l[1] != "xls"){
							...
							if (l[1] == "xls"){
								document.getElementById("unusedEquipmentFile").value = contact.replace(/.{0,}\\/, "");//获取jsp页面hidden的值
