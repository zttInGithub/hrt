...
<script type="text/javascript">
	$(function(){
		$('#storageMachineModel_10497').combogrid({
	...
	$(function(){
		$('#storageBrandName_10497').combogrid({
...
<form id="sysAdmin_10497_addForm" style="padding-left:20px;" method="post">
   	<fieldset style="width: 800px;">
		<legend>库存调拨信息</legend>
   		<table class="table1">
   			<tr>
   				<th>调出库位：</th>
   			...
   			<tr>
   				<th>品牌：</th>
   				<td><input type="text" name="storageBrandName" id="storageBrandName_10497" style="width: 155px;" class="easyui-validatebox" data-options="validType:'spaceValidator',editable:false" maxlength="50"><font color="red">&nbsp;*</font></td>
   				<th>机型：</th>
   				<td><input type="text" name="storageMachineModel" id="storageMachineModel_10497" style="width: 155px;" class="easyui-validatebox" data-options="validType:'spaceValidator',editable:false" maxlength="10"><font color="red">&nbsp;*</font></td>
   			</tr>
   			<tr>
   				<th>数量：</th>
   			...
   			<input type="hidden" name="storageType" value="4">
   		</table>
	</fieldset>
</form>