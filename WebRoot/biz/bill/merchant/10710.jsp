...
<script type="text/javascript">
	...
	//初始化datagrid
	$(function() {
		$('#sysAdmin_merchantmicrojoin_10710_datagrid').datagrid({
			url :'${ctx}/sysAdmin/merchant_listMicroMerchantInfoWJoin.action',
			fit : true,
			fitColumns : true,
			border : false,
			pagination : true,
	...
	function sysAdmin_merchantmicrojoin_editFun(){
		var checkedItems = $('#sysAdmin_merchantmicrojoin_10710_datagrid').datagrid('getChecked');
		var names = [];
		var result = true;
					...
					$('#sysAdmin_merchantmicrojoin_editForm').form('submit', {
						...
						success:function(data) {
							...
							if (result.sessionExpire) {
				    			...
				    			if (result.success) {
				    				$('#sysAdmin_merchantmicrojoin_10710_datagrid').datagrid('unselectAll');
				    				$('#sysAdmin_merchantmicrojoin_10710_datagrid').datagrid('reload');
	...
	function sysAdmin_merchantmicrojoin_queryFun(index,bmid,mid){
		$('<div id="sysAdmin_merchantmicrojoin_queryDialog"/>').dialog({
		    ...
		    modal: true,
		    onLoad:function() {
		    	var rows = $('#sysAdmin_merchantmicrojoin_10710_datagrid').datagrid('getRows');
				var row = rows[index];
	...
	function sysAdmin_merchantmicroAuid_searchFun20() {
		$('#sysAdmin_merchantmicrojoin_10710_datagrid').datagrid('load', serializeObject($('#sysAdmin_merchantmicroAuid_searchForm')));  
	} 
...
<div class="easyui-layout" data-options="fit:true, border:false">
	...
	<div data-options="region:'center', border:false" style="overflow: hidden;">  
		<table id="sysAdmin_merchantmicrojoin_10710_datagrid" style="overflow: hidden;"></table>
	</div>
