...
<script type="text/javascript">
	...
	//初始化datagrid
	$(function() {
		$('#sysAdmin_10430_1_datagrid').datagrid({
			url :'',
			fit : true,
			fitColumns : true,
			border : false,
	...
	function sysAdmin_terminalinfo10430_exportFun() {
		$('#sysAdmin_10430_1_searchForm').form('submit',{
			    		url:'${ctx}/sysAdmin/merchantterminalinfo_exportAddTerminalInfo.action?mid=864'
			    	});
	}
	//勾选导出
	function sysAdmin_terminalinfoSelected10430_exportFun() {
		var checkedItems = $('#sysAdmin_10430_1_datagrid').datagrid('getChecked');
		var names = [];
		...
		$('#sysAdmin_10430_1_searchForm').form('submit',{
			    		...
			    		success:function(data){
			    			...
			    			if (result.sessionExpire) {
				    			...
				    			if (result.success) {
			    					$('#sysAdmin_10430_1_datagrid').datagrid('reload');
			    					$.messager.show({
										title : '提示',
										msg : result.msg
									});
					    			...
					    			$('#sysAdmin_10430_1_datagrid').datagrid('unselectAll');
	...
	function sysAdmin_merchantconfirmY_editFun(index){
		$('<div id="sysAdmin_merchantconfirm_openDialog"/>').dialog({
		    ...
		    modal: true,
		    onLoad:function() {
		    	var rows = $('#sysAdmin_10430_1_datagrid').datagrid('getRows');
				var row = rows[index];	
    ...
    //表单查询
	function sysAdmin_10430_1_searchFun10() {
		//$('#sysAdmin_10430_1_datagrid').datagrid('load', serializeObject($('#sysAdmin_10430_1_searchForm'))); 
		var opts = $("#sysAdmin_10430_1_datagrid").datagrid("options");
	    opts.url = "${ctx}/sysAdmin/merchantterminalinfo_listMerchantTerminalInfoZ1.action";
	    $("#sysAdmin_10430_1_datagrid").datagrid("load", serializeObject($('#sysAdmin_10430_1_searchForm')));
	}

	//清除表单内容
	function sysAdmin_10430_1_cleanFun10() {
		$('#sysAdmin_10430_1_searchForm input').val('');
	}
</script>
<div class="easyui-layout" data-options="fit:true, border:false">
	<div data-options="region:'north',border:false" style="height:60px; overflow: hidden; padding-top:10px;">
		<form id="sysAdmin_10430_1_searchForm" style="padding-left:10%">
			...
			<table class="tableForm" >
				<tr>
					...
					<td colspan="5" style="text-align: center;">
						...
						onclick="sysAdmin_10430_1_searchFun10();">查询</a> &nbsp;
						<a href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'icon-cancel',plain:true" 
						onclick="sysAdmin_10430_1_cleanFun10();">清空</a>	
					</td>
				</tr>
			</table>
		</form>
 	...
 	<div data-options="region:'center', border:false" style="overflow: hidden;">  
		<table id="sysAdmin_10430_1_datagrid" style="overflow: hidden;"></table> 
	</div>
</div>
