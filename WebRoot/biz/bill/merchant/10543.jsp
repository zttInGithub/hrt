			...
			success:function(data) {
    			var json=eval(data);
	    			...
	    			function showBigImg(img){
	    				...
	    				$('#sysAdmin_10543_addForm').after(imgDialog);
	    				$("#img").attr("src",img);
...
<form id="sysAdmin_10543_addForm" method="post">
	<fieldset>
		<legend>工单信息</legend>
		<table class="table">
			<tr>
	    	...
	    	<tr>
	    		<th>结算周期：</th>
	    		<td>
	    			<input type="text" name="settleCycle" id="settleCycle" readonly="readonly"  value=""/>
	    		</td>
	    	</tr>
	    	<tr>
    		<th>工单描述：</th>
