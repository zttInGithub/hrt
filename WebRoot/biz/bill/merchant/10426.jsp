...
<script type="text/javascript"> 
	$(function(){
	    		...
	    		data:{bmid:bmid},
	   			success:function(data) {
		    		...
		    		if (json!="") { 
			    		...
			    		var path12='${ctx}/sysAdmin/rand_ImageShow.action?upload='+(json[6]);
		...
		$("#materialUpLoad6File").uploadPreview({ Img: "ImgPr18", Width: 120, Height: 120 });
		$("#bigdealUpLoadFile").uploadPreview({ Img: "ImgPr19", Width: 120, Height: 120 });
	});
...
<div class="easyui-layout"  data-options="fit:true, border:false">
	<div data-options="region:'north',border:false" style="height:500px; padding-top:10px;">	
		<%-- 
			优惠商户基本信息工单from表单
		--%>
		<form id="sendInfo3" style="padding-left:2%;padding-top:1%" method="post" enctype="multipart/form-data">
			...
			<fieldset style="width: 900px;">
				...
				<table class="table">
					...
					<tr>
						<th>优惠商户特殊材料：</th>
				   		<td>
				   			<input type="file" name="materialUpLoad6File" id="materialUpLoad6File"  data-options="required:true,validType:'imgValidator'"/><font color="red">&nbsp;*</font>
			...
			<input type="hidden" name="isM35" id="isM35" value="4">
			<input type="hidden" name="valuationType" id="valuationType" value="2">
