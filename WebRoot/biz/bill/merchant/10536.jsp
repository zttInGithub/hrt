	    			...
	    			if (json!="") {  
		    			...
		    			if(json[0].mtype!=1){
		    				$("#singleLimit").val(json[0].singleLimit);
   	    					...
   	    					$("#singleLimit1").val(json[0].singleLimit1);
   	    					$("#dailyLimit1").val(json[0].dailyLimit1);
...
<form id="sysAdmin_10536_addForm" method="post">
	...
	<table class="table1">
		<tr>
    		...
    		<th>机构名称：</th>
    		<td>
    		<input type="text" readonly="readonly" name="unName" id="unName">
    		</td>
    	</tr>
    	<tr>
    		<th>商户名称：</th>
	...
	<fieldset>
		...
		<table class="table">
			<tr>
	    		...
	    		<th>工单类型：</th>
	    		<td><input type="text"  id="type1" style="width:200px;" readonly="readonly"  class="easyui-validatebox" /></td>
	    	</tr>
<!-- 	    	<tr id="daijika">
	    		<th id="daijika">单日限额：</th>
	    		<td><input type="text" name="dailyLimit" id="dailyLimit2" style="width:100px;" readonly="readonly"  class="easyui-validatebox" data-options="validType:'intOrFloat'"/></td>
				
	    		<td><input type="text" name="singleLimit" id="singleLimit2" style="width:100px;" readonly="readonly"   class="easyui-validatebox" data-options="validType:'intOrFloat'"/></td>
			</tr> -->
			<tr>
				<th id="daijika">单日限额：</th>
	    		<th id="daijika1">贷记卡单日限额：</th>
	    		<td><input type="text" name="dailyLimit" id="dailyLimit" style="width:100px;" readonly="readonly"  class="easyui-validatebox" data-options="validType:'intOrFloat'"/></td>
				<th id="daijika2">单笔限额：</th>
				<th id="daijika3">贷记卡单笔限额：</th>
	    		<td><input type="text" name="singleLimit" id="singleLimit" style="width:100px;" readonly="readonly"   class="easyui-validatebox" data-options="validType:'intOrFloat'"/></td>
			</tr>
			<tr id="daijika4">
	    		<th>借记卡单日限额：</th>
	    		<td><input type="text" name="dailyLimit1" id="dailyLimit1" style="width:100px;" readonly="readonly"  class="easyui-validatebox" data-options="validType:'intOrFloat'"/></td>
				<th>借记卡单笔限额：</th>
	    		<td><input type="text" name="singleLimit1" id="singleLimit1" style="width:100px;" readonly="readonly"   class="easyui-validatebox" data-options="validType:'intOrFloat'"/></td>
			</tr>
