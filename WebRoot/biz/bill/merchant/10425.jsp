...
<script type="text/javascript"> 
	$(function(){
	    		...
	    		data:{bmid:bmid},
	   			success:function(data) {
		    		...
		    		if (json!="") { 
			    		...
			    		var path13='${ctx}/sysAdmin/rand_ImageShow.action?upload='+(json[14]);
		...
		$("#accContrary").click(function(){//对公
			  $("#10425_font_hide").hide();
		});
		$("#accPrivate").click(function(){
			$("#10425_font_hide").show();
		});
		$('#busid').combogrid({
		...
		$("#sendInfo2 #posBackImgFile").uploadPreview({ Img: "ImgPr20", Width: 120, Height: 120 });
	});
				...
				<table class="table">
					...
					<tr>
						<th>结算账户证明（银行卡）正面：</th>
				   		...
				   		<th>POS结算授权书：</th>
				   		<td>
				   			<input type="file" name="materialUpLoad1File" id="materialUpLoad1File"  data-options="required:true,validType:'imgValidator'"/><font color="red" id="10425_font_hide">&nbsp;*</font>
