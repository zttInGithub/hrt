	   		...
	   		<table class="table1">
	   			<tr>
	   				...
	   				<td style="width: 280px;" colspan="3">
	   					<input type="text" id="mid"  name="mid" style="width: 150px;" class="easyui-validatebox" data-options="required:true,validType:'spaceValidator'" maxlength="200">&nbsp;*</font>
	   				</td>
	   			...
	   			<tr>
	   				...
	   				<th>设备型号：</th>
	   				<td><input id="nbmaid" name="bmaid"  data-options="required:true,validType:'spaceValidator'" style="width:155px;"><font color="red">&nbsp;*</font></td>
	   			</tr>
	   			<tr>
	   				<th>装机地址：</th>
	   				<td colspan="3"><input type="text" id="ninstalledAddress"  name="installedAddress" style="width: 580px;" class="easyui-validatebox" data-options="required:true,validType:'spaceValidator'" maxlength="200"><font color="red">&nbsp;*</font></td>
	   			
	   				<td><input type="hidden" id="ninstalledName" name="installedName" style="width: 150px;" class="easyui-validatebox" data-options="validType:'spaceValidator'" maxlength="50"></td>
	   			</tr>
	   			<tr>
	   				<th>联系人：</th>
