<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
 <!--修改黑名单商户信息 -->
<form id="hotmerchant_editForm" method="post">
<input type="hidden" name="phids" id="phids_10734"/>	
	<table style="padding-top: 5px;padding-left:20px">
		<tr>
			<td>商户名称：</td>
			<td><input name="tname" class="easyui-validatebox" style="width:200px;"/> </td>
		</tr>
		<tr>
			<td>SN号：</td>
		...
		<tr>
			...
			<td><input name="bankAccNo" class="easyui-validatebox" style="width:200px;"/> <span id="tiderror" style="color:red;"></td>
		</tr>
		<tr>
			<td>备注：</td>
