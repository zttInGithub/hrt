...
<script type="text/javascript"> 
	...
	$(function(){
		$.ajax({
			...
			success:function(data) {
				...
				if (json!="") { 
					...
					var path4='${ctx}/sysAdmin/rand_ImageShow.action?upload='+(json[1]);
		...
		//商户基本信息工单申请图片预览
		$("#sysAdmin_00332_from #accountLegalAUpLoadFile").uploadPreview({ Img: "ImgPr1", Width: 120, Height: 120 });
		$("#sysAdmin_00332_from #accountLegalBUpLoadFile").uploadPreview({ Img: "ImgPr2", Width: 120, Height: 120 });
		$("#sysAdmin_00332_from #accountLegalHandUpLoadFile").uploadPreview({ Img: "ImgPr3", Width: 120, Height: 120 });
		$("#sysAdmin_00332_from #accountAuthUpLoadFile").uploadPreview({ Img: "ImgPr4", Width: 120, Height: 120 });
	});
	...
	function showBigImg(img){
		...
		$('#sysAdmin_00332_from').after(imgDialog);
		$("#img").attr("src",img);
	...
	function rotateLeft(){
		...
		<form id="sysAdmin_00332_from" style="padding-left:2%;padding-top:1%" method="post" enctype="multipart/form-data">
			<fieldset style="width: 850px;">
				...
				<table class="table">
					<tr>
						<th>开户类型：</th>
			    		<td>
			    			<input type="radio" name="accType" id="accType1" value="1" checked="checked" disabled="disabled"/>对公
							<input type="radio" name="accType" id="accType2" value="2" disabled="disabled"/>对私
			    		</td>
						<th>开户行名称：</th>
						<td><input type="text" name="bankBranch" id="bankBranch" style="width:200px;" class="easyui-validatebox" data-options="required:true,validType:'spaceValidator'" maxlength="200" readonly="readonly"/><font color="red">&nbsp;*</font></td>
					</tr>
					<tr>
						<th>账号：</th>
						<td><input type="text" name="bankAccNo" id="bankAccNo" style="width:200px;" class="easyui-validatebox" data-options="required:true,validType:'spaceValidator'" maxlength="30" readonly="readonly"/><font color="red">&nbsp;*</font></td>
						<th>账户名称：</th>
						<td><input type="text" name="bankAccName" id="bankAccName" style="width:200px;" class="easyui-validatebox" data-options="required:true,validType:'spaceValidator'" maxlength="100" readonly="readonly"/><font color="red">&nbsp;*</font></td>
		    		</tr>
		    		<tr>
			    		<th>是否为交通银行：</th>
			    		<td>
							<input type="radio" name="bankType" id="bankType1" value="1" checked="checked" disabled="disabled"/>交通银行
							<input type="radio" name="bankType" id="bankType2" value="2" disabled="disabled"/>非交通银行
						</td>
						<th>开户银行所在地类别：</th>
			    		<td>
			    			<input type="radio" name="areaType" id="areaType1" value="1" checked="checked" disabled="disabled"/>北京
							<input type="radio" name="areaType" id="areaType2" value="2" disabled="disabled"/>非北京
			    		</td>
					</tr>
					<tr>
						<th>开户地：</th>
						<td><input type="text" name="bankArea" id="bankArea" style="width:200px;" class="easyui-validatebox" data-options="required:true,validType:'spaceValidator'" maxlength="100" readonly="readonly"/><font color="red">&nbsp;*</font></td>
			    	</tr>
			    	<tr>
			   			<th>入账人身份证正面：</th>
			   			<td>
