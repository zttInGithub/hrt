...
<script type="text/javascript"> 
	...
	$(function(){
		$.ajax({
			...
			dataType:"json", 
			data:{bautdid:bautdid,taskType:1},
			type:"post",
			success:function(data) {
				var json=eval(data);
				if (json!="") { 
					var path1='${ctx}/sysAdmin/rand_ImageShow.action?upload='+(json[3]);
					var path2='${ctx}/sysAdmin/rand_ImageShow.action?upload='+(json[4]);
		...
		<form id="sysAdmin_00331_from" style="padding-left:2%;padding-top:1%" method="post" enctype="multipart/form-data">
			<fieldset style="width: 850px;">
				...
				<table class="table">
					<tr>
			    		<th>代理商全称：</th>
			    		<td><input type="text" name="agentName" id="agentName" style="width:200px;" class="easyui-validatebox" data-options="required:true,validType:'spaceValidator'" maxlength="100" readonly="readonly"/><font color="red">&nbsp;*</font></td>
						<th>营业执照号：</th>
						<td><input type="text" name="bno" id="bno" style="width:200px;" class="easyui-validatebox" data-options="required:true,validType:'spaceValidator'" maxlength="20" readonly="readonly"/><font color="red">&nbsp;*</font></td>
					</tr>
			    	<tr>
						<th>营业地址：</th>
			    		<td >
							<input type="text" name="baddr" id="baddr" style="width:200px;" maxlength="100"  class="easyui-validatebox" data-options="required:true,validType:'spaceValidator'" readonly="readonly"/><font color="red">&nbsp;*</font>
						</td>
			    		<th>法人：</th>
			    		<td><input type="text" name="legalPerson" id="legalPerson" style="width:200px;" class="easyui-validatebox" data-options="required:true,validType:'spaceValidator'" maxlength="20" readonly="readonly"/><font color="red">&nbsp;*</font></td>
			    		
			    	</tr>
			    	<tr>
				    	<th>法人证件类型：</th>
				    	<td>
				    		<select name="legalType" id="legalType" class="easyui-combobox" data-options="panelHeight:'auto',editable:false"  style="width:205px;" disabled="disabled">
			    		...
			    		<th >法人证件号码：</th>
			    		<td ><input type="text" name="legalNum" id="legalNum" style="width:200px;" class="easyui-validatebox" data-options="required:true,validType:'spaceValidator'" maxlength="20" readonly="readonly"/><font color="red">&nbsp;*</font></td>
			    	</tr>
					<tr>
			   			<th>法人证件正面：</th>
			   			<td>
