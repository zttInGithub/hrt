...
<script type="text/javascript">
	...
	function exportMerExceldataxmh(){
	     $("#check_wechatdealdatailfrom20117_data").form('submit',{
			    		url:'${ctx}/sysAdmin/checkWechatTxnDetail_checkWechatTxnDetailExcelAll.action?trantype=8'
			    	});
	}
		//查询提交
	function check_search_20117(type){
		var txnDay = $('#20117_xmh_txnDay').datebox('getValue');
    	var txnDay1= $('#20117_xmh_txnDay1').datebox('getValue');
        ...
        if(txnDay!=null&&txnDay1!=null&&((end-start)/(24*60*60*1000))>=31){
		    ...
		    $('#sysAdmin_check20117_wechatdealdata').datagrid('load', serializeObject($('#check_wechatdealdatailfrom20117_data')));
		}
	}
		//清除表单内容
	function check_close_20117() {
		$('#check_wechatdealdatailfrom20117_data input').val('');
	}
	...
	var xmh_profitss=$("#20117_xmh_txnDay").val();
	...
	//初始化datagrid
	$(function() {
		$('#sysAdmin_check20117_wechatdealdata').datagrid({
			url :'${ctx}/sysAdmin/checkWechatTxnDetail_listCheckMerWechatdealData.action?trantype=8',
			fit : true,
			fitColumns : true,
			border : false,
			pagination : true,
...
<div class="easyui-layout" data-options="fit:true, border:false">
	<div data-options="region:'north',border:false" style="height:70px; overflow: hidden; padding-top:20px;">
		<form id="check_wechatdealdatailfrom20117_data" style="padding-left:3%" method="post">
			<table class="tableForm" >
				<tr>
						<th>机构:</th>
						<td><select name="unno" id="unno20117" class="easyui-combogrid" style="width:100px;"></select>&nbsp;&nbsp;</td>
						<th>商户号:</th>
						...
						<th>&nbsp;&nbsp;交易日期:</th>
						<td><input id="20117_xmh_txnDay" class="easyui-datebox" data-options="editable:false" name=cdateStart style="width: 120px;"/></td>
						<td>&nbsp;-&nbsp;</td>
						<td><input id="20117_xmh_txnDay1" class="easyui-datebox" data-options="editable:false" name="cdateEnd" style="width: 120px;"/>&nbsp;&nbsp;</td>
				       <td>
						<a href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'icon-search',plain:true" 
						onclick="check_search_20117();">查询</a> &nbsp;
						<a href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'icon-cancel',plain:true" 
						onclick="check_close_20117();">清空</a>	
					</td>
			    </tr>
			</table>
		</form>
    ...
    <div data-options="region:'center', border:false" style="overflow: hidden;">  
     <table id="sysAdmin_check20117_wechatdealdata" style="overflow: hidden;"></table>
     <!-- 
