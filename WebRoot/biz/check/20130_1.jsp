...
<div class="easyui-layout" data-options="fit:true, border:false">
	<div data-options="region:'north',border:false" style="height:60px; overflow: hidden; padding-top:10px;">
		<form id="check_dealdatailfrom" style="padding-left:2%">
			<table class="tableForm" >
				<tr>
					<th>商户号：</th>
					<td><input id="xmh_mid_20130" name="mid" style="width: 120px;" /></td>
				<th>交易卡号：</th>
					<td><input id="firo" name="firsix"   style="width: 120px;"/>&nbsp;-&nbsp;
						<input id="laso" name="lastfour"   style="width: 120px;"/>
					</td>					
					<th>交易日期：</th>
					<td><input id="xmh_txnDay_20130" name="txnDay" class="easyui-datebox" data-options="editable:false" style="width: 100px;"/>&nbsp;至&nbsp;
						<input id="xmh_txnDay1_20130" name="txnDay1" class="easyui-datebox" data-options="editable:false" style="width: 100px;"/>
					</td>				
					<td>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
