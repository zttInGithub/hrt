...
public interface IAgentUnitService {
	 ...
	 * @return
	 */
	String validateCostByLimit(AgentUnitBean agentUnit, UserBean user);
	 ...
	 * @return
	 */
	Map<String,HrtUnnoCostModel> getAllLimitHrtCostMap();
     ...
     * @return
     */
	DataGridBean listSalesActLiveTermDetailGrid(AgentUnitBean agentUnit, UserBean userSession);
	/**
     * 活动设备活跃明细_导出
     * @param agentUnit
     * @param user
     * @return
     */
	List<Map<String, Object>> exportSalesActLiveTermDetail(AgentUnitBean agentUnit, UserBean userSession);
	/**
     * 活动设备活跃汇总
     * @param agentUnit
     * @param user
     * @return
     */
	DataGridBean listSalesActLiveTermSumGrid(AgentUnitBean agentUnit, UserBean userSession);
	/**
     * 活动设备活跃汇总_导出
     * @param agentUnit
     * @param user
     * @return
     */
	List<Map<String, Object>> exportSalesActLiveTermSum(AgentUnitBean agentUnit, UserBean userSession);
	/**
     * 查询一代及一代以下钱包开关状态
     * @param agentUnit
     * @param user
     * @return
     */
	DataGridBean rebatetypeWalletCashSwitch(AgentUnitBean agentUnit, UserBean userBean);
	/**
     * 变更一代及一代以下钱包开关状态
     * @param agentUnit
     * @param user
     * @return
     */
	String updateRebatetypeWalletCashSwitch(AgentUnitBean agentUnit, UserBean userBean);
	/**
            * 批量变更一代及一代以下钱包开关状态
     * @param agentUnit
     * @param user
     * @return
     */
	String importrebatetypeWalletCashSwitchUpdate(String xlsfile, String fileName, UserBean user) throws InvocationTargetException, IllegalAccessException;
	/**
     * 钱包开关状态_导出
     * @param agentUnit
     * @param user
     * @return
     */
	List<Map<String, Object>> reportRebatetypeWalletCashSwitch(AgentUnitBean agentUnit, UserBean userBean);
	/**
	 *代理商户激活统计_查询
     * @param agentUnit
     * @param user
     * @return
     */
	DataGridBean queryAgentActiveSum(AgentUnitBean agentUnit, UserBean userSession);
	/**
	 *代理商户激活统计_导出
     * @param agentUnit
     * @param user
     * @return
     */
	List<Map<String, Object>> exportQueryAgentActiveSum(AgentUnitBean agentUnit, UserBean userSession);
	/**
	 *代理活跃及登录APP监测报表明细_查询
     * @param agentUnit
     * @param user
     * @return
     */
	DataGridBean queryUserLoginActiveDetail(AgentUnitBean agentUnit, UserBean userSession);
	/**
	 *代理活跃及登录APP监测报表明细_导出
     * @param agentUnit
     * @param user
     * @return
     */
	List<Map<String, Object>> exportUserLoginActiveDetail(AgentUnitBean agentUnit, UserBean userSession);
	/**
	 *代理活跃及登录APP监测报表汇总_查询
     * @param agentUnit
     * @param user
     * @return
     */
	DataGridBean queryUserLoginActiveSum(AgentUnitBean agentUnit, UserBean userSession);
	/**
	 *代理活跃及登录APP监测报表汇总_导出
     * @param agentUnit
     * @param user
     * @return
     */
	List<Map<String, Object>> exportUserLoginActiveSum(AgentUnitBean agentUnit, UserBean userSession);
}
