...
public interface IMerchantInfoService {
	...
	*/
	...
	List<Map<String, Object>> exportMicroMerSelectedPro(String bmids, UserBean userSession);
	...
	DataGridBean queryMicroMerchantInfoWJoin1(MerchantInfoBean merchantInfo,
			UserBean userBean);
	//会员宝Pro
	DataGridBean queryMicroMerchantInfoWJoinPro(MerchantInfoBean merchantInfo,
			UserBean userBean);
	...
	DataGridBean queryMerchantMicroInfoZKPlus(MerchantInfoBean merchantInfo,
											 UserBean userBean);
	DataGridBean queryMerchantMicroInfoZKPro(MerchantInfoBean merchantInfo,
			 UserBean userBean);
	/**
	 * 微商户系统添加
	 */
	...
	DataGridBean queryMicroMerchantInfoYPlus(MerchantInfoBean merchantInfo,
											UserBean userBean) throws Exception;
	DataGridBean queryMicroMerchantInfoYPro(MerchantInfoBean merchantInfo,
			UserBean userBean) throws Exception;
	...
	List<Map<String, Object>> exportMicroPro(MerchantInfoBean merchantInfo, UserBean userBean);
	...
	/**
	 * 查询法人身份证号下PRO商户绑定POS数量
	 * @param merchantInfoBean
	 * @param type
	 * @return
	 */
	Integer queryPROTidCountByLegalNum(MerchantInfoBean merchantInfoBean,Integer type);
    ...
    /**
     * 手机号是否已经存在该产品的商户(除去注销的商户)
     * @param phone
     * @return
     */
    String isExistPhoneAndAgentId(String phone,String agentId);
