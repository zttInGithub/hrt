...
public class CheckMisTakeBean {
	...
	private File orderUploadFile; // 上传单据
	private String status; // 处理状态  1:已回复；0：未回复
	private Integer orderType; // 单据类型  3查询回复  2差错调单回复 //20200330添加4欺诈交易回复
	...
	public Date getTxnDayEnd() {
		return txnDayEnd;
	}
	public void setTxnDayEnd(Date txnDayEnd) {
