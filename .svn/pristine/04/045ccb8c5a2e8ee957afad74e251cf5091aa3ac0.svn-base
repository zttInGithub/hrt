...
<script type="text/javascript"> 
	$(function(){
		...
		//商户基本信息工单申请图片预览
		$("#sysAdmin_10954_from #snImgFile").uploadPreview({ Img: "ImgPr1", Width: 120, Height: 120 });
	});
	...
	function showBigImg(img){
		...
		$('#sysAdmin_10954_from').after(imgDialog);
		$("#img").attr("src",img);
...
<form id="sysAdmin_10954_from" style="padding-left:2%;padding-top:1%" method="post" enctype="multipart/form-data">
	<table class="table">
		<tr>
			<th>商户号：</th>
   			<td>
