	...
	//查询提交
	 function check_search(){
	  ...
	  if(((end-start)/(24*60*60*1000))>31){
		 ...
		 var url = "${ctx}/phone/phoneWechatPublicAcc_listCheckUnitDealDetail.action?mid="+$("#xmh_mid_20130").val()+"&txnDay="+txnDay+"&txnDay1="+txnDay1;//+"&rowsPerPage="+rowsPerPage+"&page="+page;
		 var dataArray=0;
