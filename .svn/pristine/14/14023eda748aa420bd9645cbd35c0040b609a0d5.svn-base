...
<script type="text/javascript">
	...
	$(function(){
		...
		$('#parentUnno').combogrid({
			...
			fitColumns:true,
			columns:[[ 
				{field:'UN_NAME',title:'所属机构',width:150},
				{field:'UNNO',title:'id',width:150,hidden:true}
			]]
		});
...
<form id="sysAdmin_merchant14_addForm" method="post" enctype="multipart/form-data" >
	<fieldset>
		<legend>商户信息</legend>
		<table class="table">
			<tr>
				...
				<td >
					<select name="unno" id="parentUnno" class="easyui-combogrid" data-options="  
				        ...
				        " style="width:205px;" onchange="f1();"></select>
				</td>
		   	</tr>
		   	<tr>
		   		<th>商户注册名称：</th>
		...
		<table class="table">
			<tr>
		   	...
		   	<tr>
		   		<th>支付系统行号：</th>
		   		<td colspan="3">
		   		<input type="text" name="payBankId" style="width:200px;" class="easyui-validatebox" data-options="required:true" maxlength="20"/><font color="red">&nbsp;*支付系统行号作为结算信息依据，填写错误会影响成功付款!</font>
		   		</td>
			</tr>
		   	<tr>
				<th>是否大小额商户：</th>
