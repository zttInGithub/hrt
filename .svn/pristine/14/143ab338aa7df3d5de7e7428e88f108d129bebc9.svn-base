<%@ page language="java" import="com.hrt.frame.entity.pagebean.UserBean" pageEncoding="UTF-8" %>
...
<div class="easyui-layout"  data-options="fit:true, border:false">
	<div data-options="region:'north',border:false">
	   	<form id="sysAdmin_10491_addForm" style="padding-left:20px;" method="post">
				...
				<legend>终端信息</legend>
		   		<table class="table1">
		   			<tr>
		   				...
		   				<td><input type="hidden" value="181" id="qbmaid" name="bmaid" style="width:155px;" ><font color="red">&nbsp;*</font></td>
		   				
		   				<td style="width: 65px;"><a href="#" class="easyui-linkbutton" onclick="qaddTr()">添加</a></td>
		   			</tr>
		   			<tr>
		   				<th>装机地址：<input type="hidden" id="qinstalledName" name="installedName" value=" "></th>
			...
			<input type="hidden" name="UNNO" id="UNNO" value="<%=((UserBean)request.getSession().getAttribute("user")).getUnNo()%>" />
		</form>
	</div>
