...
<script type="text/javascript"> 
	...
	$(function(){
		...
		//商户基本信息工单申请图片预览
		$("#sysAdmin_00337_from #legalAUpLoadFile").uploadPreview({ Img: "ImgPr1", Width: 120, Height: 120 });
		$("#sysAdmin_00337_from #legalBUpLoadFile").uploadPreview({ Img: "ImgPr2", Width: 120, Height: 120 });
		$("#sysAdmin_00337_from #busLicUpLoadFile").uploadPreview({ Img: "ImgPr3", Width: 120, Height: 120 });
		$("#sysAdmin_00337_from #dealUpLoadFile").uploadPreview({ Img: "ImgPr4", Width: 120, Height: 120 });
	});
	...
	function showBigImg(img){
		...
		$('#sysAdmin_00337_from').after(imgDialog);
		$("#img").attr("src",img);
	...
	function rotateLeft(){
		...
		<form id="sysAdmin_00337_from" style="padding-left:2%;padding-top:1%" method="post" enctype="multipart/form-data">
