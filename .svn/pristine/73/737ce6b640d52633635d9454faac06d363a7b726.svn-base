 ...
 * @since 1.8
 **/
public class CheckWalletCashSwitchWDaoImpl extends BaseHibernateDaoImpl<CheckWalletCashSwitchWModel> implements CheckWalletCashSwitchWDao {
}
