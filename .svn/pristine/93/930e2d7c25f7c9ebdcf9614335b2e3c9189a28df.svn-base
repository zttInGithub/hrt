...
<script type="text/javascript">
	...
	$(function() {
		$('#sysAdmin_10530_datagrid').datagrid({
			url :'${ctx}/sysAdmin/merchantTaskOperate_queryMerchantRiskTaskData.action',
			fit : true,
			fitColumns : true,  
			border : false,
			nowrap : true,
		...
		<form id="check_10530_dataForm" style="padding-left:3%">
			...
			<table class="tableForm" >
				<tr>
						...
						<th>工单类型：</th>
						<td><select name="mtype" class="easyui-combobox" data-options="panelHeight:'auto',editable:false"  style="width:140px;">
			    				<option value="" selected="selected">查询全部</option>
								<option value="0">刷卡</option>
								<option value="1">扫码</option>
			    			</select>&nbsp;&nbsp;&nbsp;&nbsp;</td>
						<th>受理日期：</th>
						<td><input id="startDay" class="easyui-datebox" data-options="editable:false" name="startDay" style="width: 147px;"/></td>
						<td>—</td>
						<td><input id="endDay" class="easyui-datebox" data-options="editable:false" name="endDay" style="width: 147px;"/>&nbsp;&nbsp;&nbsp;&nbsp;</td>
						<th>授权状态：</th>
						<td>
