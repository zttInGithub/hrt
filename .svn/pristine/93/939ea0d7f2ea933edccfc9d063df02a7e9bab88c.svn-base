...
<script type="text/javascript">
	$(function(){
		$('#storageMachineModel_10495').combogrid({
	...
	$(function(){
		$('#storageBrandName_10495').combogrid({
...
.table1 td{
	width:300px;
   	...
   	<form id="sysAdmin_10495_addForm" style="padding-left:20px;" method="post">
	   	<fieldset style="width: 800px;">
			<legend>修改盘盈盘亏信息</legend>
	   		<table class="table1">
	   			<tr>
	   				<th>类型：</th>
	   				...
	   				<th>品牌：</th>
	   				<td><input type="text" name="storageBrandName" id="storageBrandName_10495" style="width: 155px;" class="easyui-validatebox" data-options="validType:'spaceValidator',editable:false" maxlength="50"><font color="red">&nbsp;*</font></td>
	   			</tr>
	   			<tr>
	   				<th>机型：</th>
	   				<td><input type="text" name="storageMachineModel" id="storageMachineModel_10495" style="width: 155px;" class="easyui-validatebox" data-options="validType:'spaceValidator',editable:false" maxlength="10"><font color="red">&nbsp;*</font></td>
	   				<th>数量：</th>
