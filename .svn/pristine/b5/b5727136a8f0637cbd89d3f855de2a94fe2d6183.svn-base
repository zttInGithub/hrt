...
<script type="text/javascript">
	...
	var allRebateType20600_1 = new Array();
	function sysAdmin_20600_1_addRebate(){
		$('<div id="sysAdmin_20600_1_addDialog"/>').dialog({
			title: '<span style="color:#157FCC;">添加活动类型</span>',
			width: 550,
		    height:560,
		    closed: false,
		    href: '${ctx}/biz/check/20600_1_1.jsp',  
		    modal: true,
		    buttons:[{
		    	text:'确认',
		    	iconCls:'icon-ok',
		    	handler:function() {
		    		sysAdmin_20600_1_edit();
		    		$('#sysAdmin_20600_1_addDialog').dialog('destroy');
		    	}			    
			},{
				text:'取消',
				iconCls:'icon-cancel',
	...
	var j = 1;
	function sysAdmin_20600_1_edit(){
		var tr_list = $("#20600_1_table").children("tr");
		var id = tr_list.length;
		var rebateType = $('#rebateType_20600_1_1').combobox('getValue');
		
		var creditBankRate = $('#creditBankRate_20600_1_1').val();
		var cashRate = $('#cashRate_20600_1_1').val();
		var ruleThreshold = $('#ruleThreshold_20600_1_1').val();
		var startAmount = $('#startAmount_20600_1_1').val();
		var scanRate = $('#scanRate_20600_1_1').val();
		var cashAmt1 = $('#cashAmt1_20600_1_1').val();
		var scanRate1 = $('#scanRate1_20600_1_1').val();
		var profitPercent1 = $('#profitPercent1_20600_1_1').val();
		var scanRate2 = $('#scanRate2_20600_1_1').val();
		var cashAmt2 = $('#cashAmt2_20600_1_1').val();
		
		
		var huabeiRate = $("#huabeiRate_20600_1_1").val();
		var huabeiFee = $("#huabeiFee_20600_1_1").val();
		/* var rate = $("#rate_20600_1_1").val();
		var scanRate = $("#scanRate_20600_1_1").val();
		var cash = $("#cash_20600_1_1").val();
		var cashAmt1 = $("#cashAmt1_20600_1_1").val(); */
		var validator = $('#sysAdmin_20600_1_1_from').form('validate');
		if(!validator){
			$.messager.alert('提示', "填写活动类成本信息有误");
			return ;
		}
		if(allRebateType20600_1.indexOf(rebateType)!=-1){
			$.messager.alert('提示', "已添加该活动的成本，请勿重复添加");
			return ;
		}
		allRebateType20600_1[allRebateType20600_1.length] = rebateType;
		var html = '<tr id="tr_20600_1_'+j+'" >'
			+'<tr id="tr_20600_1_'+j+'">'
			...
			+'</tr>';
			// console.log(html);
		$("#20600_1TRebateType").before(html);
		j ++;
	}
	
</script>
<form id="profitmicro_20600_addForm" method="post" enctype="multipart/form-data" >
	<fieldset>
	  <table class="table">
		 <tr>
		   	<th>模版名称：</th>
	...
	<input type="hidden" name="Tempname" id="Tempname_20600_1" />
</form> 
	<fieldset>
		<legend>活动</legend>
	  <table class="table">
		<tbody id="20600_1_table">
			<tr id="20600_1TRebateType">
				<td style="text-align: center;" colspan="9">
					<a id="" onclick="sysAdmin_20600_1_addRebate()" class="l-btn" href="javascript:void(0)"><span class="l-btn-left"><span class="l-btn-text icon-add" style="padding-left: 20px;">添加活动</span></span></a>
				</td>
			</tr>
		</tbody>
	  </table>
