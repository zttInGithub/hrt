...
<script type="text/javascript">
	...
	$(function() {
		$('#sysAdmin_10431_datagrid').datagrid({
...
<div class="easyui-layout" data-options="fit:true, border:false">
	<div data-options="region:'north',border:false" style="height:200px;">
	   	<form id="sysAdmin_10431_addForm" style="padding-left:20px;" method="post">
				...
				<legend>采购单信息</legend>
		   		<table class="table1">
		   			<tr>
		   				...
		   				<th>大类：</th>
		   				<td>
			    			<input type="text" name="ORDERMETHOD" id="orderMethod_10431" style="width: 150px;" class="easyui-validatebox" data-options="validType:'spaceValidator'" readonly="readonly">
	   					</td>
		   			</tr>
		   			<tr>
		   				<th>供应商名称：</th>
		   				...
		   				<th>采购日期：</th>
		   				<td><input type="text" name="ORDERDAY" style="width: 150px;" class="easyui-validatebox" data-options="" readonly="readonly"></td>
		   			</tr>
		   			<tr>
		   				<th>联系人：</th>
		   				<td><input type="text" name="CONTACTS"  style="width: 150px;" class="easyui-validatebox" data-options="validType:'spaceValidator'" readonly="readonly"></td>
		   				<th>联系电话：</th>
	...
	<div data-options="region:'center', border:false" style="overflow: hidden;">
		<table id="sysAdmin_10431_datagrid"></table>
	</div> 
</div>
