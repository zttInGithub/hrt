		...
		<form id="check_transferProfit_20307Form" style="padding-left: 3%">
			<table>
				<tr>
					...
					<th>活动类型</th>
					<td>
						<select id="rebateType_20307" name="maintainType" class="easyui-combogrid" data-options="validType:'spaceValidator'" style="width:135px;"></select>
					</td>
					<td style="width: 15px"></td>
					<td>
					&nbsp;&nbsp;&nbsp;&nbsp;
