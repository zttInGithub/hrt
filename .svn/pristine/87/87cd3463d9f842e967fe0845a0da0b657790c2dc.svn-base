...
<script type="text/javascript">
	...
	$(function() {
		$('#sysAdmin_10421_datagrid').datagrid({
...
<div class="easyui-layout" data-options="fit:true, border:false">
	<div data-options="region:'north',border:false" style="height:251px;">
	   	<form id="sysAdmin_10421_addForm" style="padding-left:20px;" method="post">
				...
				<legend>采购单信息</legend>
		   		<table class="table1">
		   			<tr>
		   				...
		   				<th>大类：</th>
		   				<td>
			    			<input type="text" name="orderMethod" id="orderMethod_10421" style="width: 150px;" class="easyui-validatebox" data-options="validType:'spaceValidator'" readonly="readonly">
	   					</td>
		   			</tr>
		   			<tr>
		   				<th>供应商名称：</th>
	...
	<div data-options="region:'center', border:false" style="overflow: hidden;">
		<table id="sysAdmin_10421_datagrid"></table>
	</div> 
</div>
