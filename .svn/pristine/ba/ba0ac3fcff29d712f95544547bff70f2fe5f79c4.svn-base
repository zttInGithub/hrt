...
<script type="text/javascript">
	...
	$(function() {
		$("#parentUnitName").combobox({
			...
			onSelect:function(rec){
				...
				$('#sysAdmin_merchantList_datagrid').datagrid('load', serializeObject($('#sysAdmin_10480_searchForm')));
			}
		});
		$('#sysAdmin_merchantList_datagrid').datagrid({
	...
	function sysAdmin_merchantterminalinfo_exportFun() {
		var txnDay = $('#createDateStart_10480').datebox('getValue');
    	var txnDay1= $('#createDateEnd_10480').datebox('getValue');
	...
	function sysAdmin_merchantterminalinfoSelected_exportFun() {
		var checkedItems = $('#sysAdmin_merchantList_datagrid').datagrid('getChecked');
		var names = [];
	...
	/* function showBigImg(img){
		...
		$('#sysAdmin_merchantList_datagrid').after(imgDialog); 
		$("#img").attr("src",img);
...
<div class="easyui-layout" data-options="fit:true, border:false">
	<div data-options="region:'north',border:false" style="height:120px; overflow: hidden; padding-top:20px;">
		<form id="sysAdmin_10480_searchForm" style="padding-left:3%" method="post">
		<input type="hidden" id="bmids_480" name="bmids" />
			<table class="tableForm" >
				...
				<tr>
					...
					<th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;审批时间</th>
					<td><input name="createDateStart" id="createDateStart_10480" class="easyui-datebox" data-options="editable:false" style="width: 150px;"/>&nbsp;至&nbsp;
						<input name="createDateEnd" id="createDateEnd_10480" class="easyui-datebox" data-options="editable:false" style="width: 150px;"/>
					</td>
    ...
    <div data-options="region:'center', border:false" style="overflow: hidden;">  
      <table id="sysAdmin_merchantList_datagrid" style="overflow: hidden;"></table>
    </div> 
</div>
