...
<script type="text/javascript">
	...
	// debugger;
	if(mid.indexOf("HRTSYT")==-1){
		$(".syt_scanRate_info").remove();
	}
	$(function() {
...
<form id="sysAdmin_merchantmicroList_queryForm" method="post" enctype="multipart/form-data" >
	...
	<fieldset>
		...
		<table class="table">
			...
			<tr class="syt_scanRate_info">
				<th>微信/支付宝1000以下（含）：</th>
				<td><input type="text" readonly="readonly" name="scanRate" style="width:200px;"/></td>

				<th>微信/支付宝1000以上：</th>
				<td><input type="text" readonly="readonly" name="scanRateAll" style="width:200px;"/></td>
			</tr>
			<tr class="syt_scanRate_info">
				<th>银联二维码：</th>
