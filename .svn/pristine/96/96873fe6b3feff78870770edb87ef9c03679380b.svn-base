...
<script type="text/javascript">
	...
	$(function() {
		$('#sysAdmin_10535_datagrid').datagrid({
			url :'${ctx}/sysAdmin/taskDataApprove_initRiskApp.action',
			fit : true,
			fitColumns : true,
			border : false,
			pagination : true,
	...
	function sysAdmin_taskDataApprove_editFun(index,id,unno) {
		$('<div id="sysAdmin_10535_editDialog"/>').dialog({
		    ...
		    maximizable:true,
		    closed: false,
		    href: '${ctx}/biz/bill/merchant/10536.jsp?bmtkid1='+id,  
		    modal: true,
		    onLoad:function() {
		    	var rows = $('#sysAdmin_10535_datagrid').datagrid('getRows');
				var row = rows[index];
		...
		<form id="sysAdmin_10535_searchForm" style="padding-left:3%">
			<table class="tableForm" >
				<tr>
					...
					<th>&nbsp;&nbsp;&nbsp;工单类型：</th>
						<td><select name="mtype" class="easyui-combobox" data-options="panelHeight:'auto',editable:false"  style="width:80px;">
