...
<script type="text/javascript">
	...
	$(function() {
		$('#sysAdmin_10510_datagrid').datagrid({
			url :'${ctx}/sysAdmin/merchantterminalinfo_listMerchantTerminalInfobaodan.action',
			fit : true,
			fitColumns : true,
			border : false,
			pagination : true,	
	...
	<form id="sysAdmin_10510_searchForm" style="padding-left:10%">
		...
		<table class="tableForm" >
			<tr>
				...
				<th >终端编号</th>
				<td><input name="tid" style="width: 80px;" /></td>
				<th>申请日期：</th>
				<td><input id="startDay" class="easyui-datebox" data-options="editable:false" name="maintainDateStr" style="width: 156px;"/></td>
				<td>&nbsp;-&nbsp;</td>
				<td><input id="endDay" class="easyui-datebox" data-options="editable:false" name="approveDateStr" style="width: 156px;"/>&nbsp;&nbsp;&nbsp;&nbsp;</td>
				<td>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
