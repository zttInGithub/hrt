...
<script type="text/javascript">
 	...
 	function showBigImg(img){
 		...
 		$('#sysAdmin_agentopen_editForm').after(imgDialog);
 		$("#img").attr("src",img);
...
<form id="sysAdmin_agentopen_editForm" method="post">
	...
	<fieldset>
		...
		<table class="table">
			<tr>
				...
				<th>代理商级别：</th>
				<td colspan="3">
					<select name="agentAttr" style="width:205px;" >
		...
		<fieldset>
			...
			<table class="table">
				<tr>
		    		...
		    		<th>保证金：</th>
	    			<td colspan="3"><input type="text" name="riskAmount" style="width:130px;" class="easyui-numberbox" readonly="readonly"/></td>
				</tr>
				<tr>
	    			<th>合同编号：</th>
