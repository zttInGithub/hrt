...
<script type="text/javascript"> 
	$(function(){
	    		...
	    		data:{bmid:bmid},
	   			success:function(data) {
		    		...
		    		if (json!="") { 
			    		...
			    		var path11='${ctx}/sysAdmin/rand_ImageShow.action?upload='+(json[12]);
			    		var path12='${ctx}/sysAdmin/rand_ImageShow.action?upload='+(json[13]);
			    		var path13='${ctx}/sysAdmin/rand_ImageShow.action?upload='+(json[6]);
		...
		//商户基本信息工单申请图片预览
		$("#registryUpLoadFile").uploadPreview({ Img: "ImgPr8", Width: 120, Height: 120 });
		$("#photoUpLoadFile").uploadPreview({ Img: "ImgPr9", Width: 120, Height: 120 });
		$("#bupLoadFile").uploadPreview({ Img: "ImgPr10", Width: 120, Height: 120 });
		$("#legalUploadFile").uploadPreview({ Img: "ImgPr11", Width: 120, Height: 120 });
		$("#materialUpLoadFile").uploadPreview({ Img: "ImgPr12", Width: 120, Height: 120 });
		$("#materialUpLoad3File").uploadPreview({ Img: "ImgPr13", Width: 120, Height: 120 });
		$("#materialUpLoad4File").uploadPreview({ Img: "ImgPr14", Width: 120, Height: 120 });
		$("#materialUpLoad5File").uploadPreview({ Img: "ImgPr15", Width: 120, Height: 120 });
		$("#rupLoadFile").uploadPreview({ Img: "ImgPr16", Width: 120, Height: 120 });
		$("#materialUpLoad1File").uploadPreview({ Img: "ImgPr17", Width: 120, Height: 120 });
		$("#sendInfo4 #materialUpLoad6File").uploadPreview({ Img: "ImgPr18", Width: 120, Height: 120 });
		$("#sendInfo4 #materialUpLoad7File").uploadPreview({ Img: "ImgPr19", Width: 120, Height: 120 });
		$("#sendInfo4 #bigdealUpLoadFile").uploadPreview({ Img: "ImgPr20", Width: 120, Height: 120 });
	});
...
<div class="easyui-layout"  data-options="fit:true, border:false">
	<div data-options="region:'north',border:false" style="height:500px; padding-top:10px;">	
		<%-- 
			减免商户基本信息工单from表单
		--%>
		<form id="sendInfo4" style="padding-left:2%;padding-top:1%" method="post" enctype="multipart/form-data">
				...
				<table class="table">
					...
					<tr>
	   				...
	   				<tr>
	   					<th>法人姓名：</th>
			   			<td>
			   				<input type="text" name="legalPerson" style="width:200px;" class="easyui-validatebox" data-options="required:true" maxlength="10"/><font color="red">&nbsp;*</font>
			   			</td>
			   			<th>法人证件类型：</th>
				   		<td>
			...
			<fieldset style="width: 900px;">
				...
				<table class="table">
					...
					<tr>
						<th>拓展销售：</th>
	   					<td>
	   						<select id="busid" name="busid" class="easyui-combogrid easyui-validatebox" data-options="required:true,editable:false" style="width:205px;"></select><font color="red">&nbsp;*</font>
	   					</td>
					</tr>
				</table>
			</fieldset> 
			<fieldset style="width: 900px;">
				...
				<table class="table">
					<tr>
						<th>店面门头照片：</th>
			   			<td>
			   				<input type="file" id="registryUpLoadFile" name="registryUpLoadFile"   data-options="required:true,validType:'imgValidator'" /><font color="red">&nbsp;*</font>
					...
					<tr>
						<th>减免商户特殊材料1：</th>
				   		<td>
				   			<input type="file" id="materialUpLoad6File" name="materialUpLoad6File"  data-options="required:true,validType:'imgValidator'"/><font color="red">&nbsp;*</font>
				   			<div><img id="ImgPr18" width="120" height="120" /></div>
				   		</td>
				   		<th>减免商户特殊材料2：</th>
				   		<td>
				   			<input type="file" id="materialUpLoad7File" name="materialUpLoad7File"  data-options="required:true,validType:'imgValidator'"/><font color="red">&nbsp;*</font>
					...
					<tr>
						<th>大协议照片：</th>
				   		<td>
				   			...
				   			<div><img id="ImgPr20" width="120" height="120" /></div>
				   		</td>
				   		<th></th>
				   		<td></td>
					</tr>
			...
			<input type="hidden" name="isM35" id="isM35" value="5">
			<input type="hidden" name="valuationType" id="valuationType" value="3">
