...
public class HrtUnnoCostBean implements Serializable{
	...
	private Integer txnType;	//产品类型 1-秒到、2-理财、3-信用卡代还、4-云闪付、5-快捷、6-T0、7-T1
	private Integer txnDetail;	//产品细分 1-0.6秒到、2-0.72秒到、3-理财、4-信用卡代还、5-云闪付、6-快捷VIP、7-快捷完美、8-微信、
								//9-支付宝、10-银联二维码、11-传统-标准、12-传统-优惠、13-传统-减免
