...
<script type="text/javascript">
	...
	$(function() {
		$('#sysAdmin_menu_treegrid').treegrid({
			url : '${ctx}/sysAdmin/menu_listMenusTreegridbaodan.action',
			fit : true,
			fitColumns : true,
			border : false,
			animate : true,		
			...
			columns : [[{
				...
				align : 'center',
				formatter : function(value,row,index) {
					return'<img src="${ctx}/images/frame_remove.png" title="删除" style="cursor:pointer;" onclick="sysAdmin_menu_delFun('+row.menuID+')"/>&nbsp;&nbsp'+
